import { Database, FileText, Moon, Network, Search, Sun } from 'lucide-react'
    ...
    <nav>
      {props.connection === undefined ? null : (
        <button
          ...
          title={`Connected to ${props.connection.name} (${props.connection.target})`}
